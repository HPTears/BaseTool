...
+ (BOOL)isCameraAvailable {
    if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        [DNAlertUtil presentAlertViewWithTitle:nil message:@"没有相机功能" confirmTitle:@"确定" handler:nil];
        return NO;
    }
...
+ (void)showAlertText:(NSString *)text {
    [DNAlertUtil presentAlertViewWithTitle:@"温馨提示" message:text cancelTitle:@"取消" defaultTitle:@"确定" distinct:NO cancel:^{
        // nothing
    } confirm:^{
